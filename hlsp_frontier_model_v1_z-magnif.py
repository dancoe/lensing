...
def savemagnif(inkappa, inshear, zl, outfile, zsout):
...
if __name__ == '__main__':
    if not len(sys.argv) > 1:
        print
        print 'USAGE: python hlsp_frontier_model_v1_z-magnif.py inkappa.fits inshear.fits lensredshift outmagnif.fits outredshift'
        print 'EXAMPLE: python hlsp_frontier_model_v1_z-magnif.py hlsp_frontier_model_abell2744_cats_v1_kappa.fits hlsp_frontier_model_abell2744_cats_v1_gamma.fits 0.308 magnif_z11.fits 11'
    ...
    outfile = sys.argv[4]
    zsout = float(sys.argv[5])  # Source redshift you are interested in (output)
    savemagnif(inkappa, inshear, zl, outfile, zsout)
